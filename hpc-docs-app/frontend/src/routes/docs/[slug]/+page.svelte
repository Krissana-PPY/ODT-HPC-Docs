...
{:else if slug === 'intro'}
	<div class="max-w-4xl mx-auto px-6 py-10">
		...
		<div class="my-10">
			...
			<p class="text-center text-sm text-gray-500 mt-3">ภาพรวมระบบ HPC Cluster</p>
		</div>
		...
		<div class="warning-box">
			<p class="font-semibold text-amber-800 mb-2">กฎสำคัญที่ต้องปฏิบัติ:</p>
			<ul class="text-amber-700 space-y-2 list-none pl-0 mb-0">
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />
					</svg>
					<span><strong>ห้ามรันโปรแกรมหนักบน Login Node</strong> โดยตรง ให้ใช้ Slurm (sbatch/srun) เสมอ</span>
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" />
					</svg>
					<span>บันทึกผลลัพธ์สำคัญไว้ที่ <code>/home</code> เท่านั้น ข้อมูลใน <code>/scratch</code> จะถูกลบหลังงานสิ้นสุด</span>
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
					</svg>
					<span>โควตา Home Directory คือ 300 GB ตรวจสอบการใช้งานด้วย: <code>du -sh /home/$USER</code></span>
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
					</svg>
					<span>เมื่องานถึงเวลาสูงสุด Slurm จะหยุดงานนั้น ให้บันทึก checkpoint สำหรับงานที่ใช้เวลานาน</span>
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-amber-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
						<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
					</svg>
					<span>ห้ามเข้าถึงหรือแก้ไขไฟล์ของผู้ใช้คนอื่น</span>
				</li>
			</ul>
		</div>
	</div>
	...
	<div class="max-w-4xl mx-auto px-6 py-10">
		...
		<div class="my-10">
			<img src="{imageBase}/image (2).png" alt="Open OnDemand หน้าหลัก"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">หน้า Open OnDemand</p>
		</div>
		...
		<div class="info-box">
			...
			<ul class="text-blue-700 text-sm space-y-1 list-none pl-0 mb-0">
				...
				<li class="flex items-center gap-2">
					...
					<code>mix</code> = ใช้งานบางส่วน
				</li>
				<li class="flex items-center gap-2">
					<span class="inline-block w-2.5 h-2.5 rounded-full bg-red-500"></span>
					<code>alloc</code> = ใช้งานเต็ม
				</li>
				<li class="flex items-center gap-2">
					<span class="inline-block w-2.5 h-2.5 rounded-full bg-gray-500"></span>
					<code>down</code> = ไม่พร้อมใช้งาน
				</li>
			</ul>
		</div>
		...
		<div class="my-10">
			<img src="{imageBase}/image (3).png" alt="Job Composer"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">Job Composer</p>
		</div>
		...
		<div class="my-10">
			<img src="{imageBase}/image (4).png" alt="New Job Template"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">New Job from Default Template</p>
		</div>
		...
		<div class="my-10">
			<img src="{imageBase}/image (5).png" alt="Edit Files"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">Edit Files</p>
		</div>
		...
		<div class="my-10">
			<img src="{imageBase}/image (6).png" alt="Upload Files"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">Upload ไฟล์</p>
		</div>
		...
		<div class="my-10">
			<img src="{imageBase}/image (7).png" alt="Edit main_job.sh"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">แก้ไข main_job.sh</p>
		</div>
...
python3 my_script.py`}
		...
		<div class="my-10">
			<img src="{imageBase}/image (8).png" alt="Save Script"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">บันทึก Script</p>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
			<div>
				<img src="{imageBase}/image (9).png" alt="Submit Job"
					class="w-full rounded-lg border border-gray-200 shadow-sm" />
				<p class="text-center text-sm text-gray-500 mt-3">Submit Job</p>
			</div>
			<div>
				<img src="{imageBase}/image (10).png" alt="Job Result"
					class="w-full rounded-lg border border-gray-200 shadow-sm" />
				<p class="text-center text-sm text-gray-500 mt-3">ผลลัพธ์งาน</p>
			</div>
		</div>
...
ssh user1@klpdindaeng-ood.kku.ac.th`} />
		...
		<div class="my-8">
			...
			<p class="text-sm text-gray-500 mt-3">การตั้งค่า PuTTY</p>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
			<div>
				<img src="{imageBase}/image (12).png" alt="MobaXterm 1"
					class="w-full rounded-lg border border-gray-200 shadow-sm" />
				<p class="text-center text-sm text-gray-500 mt-3">MobaXterm - ขั้นตอนที่ 1</p>
			</div>
			<div>
				<img src="{imageBase}/image (13).png" alt="MobaXterm 2"
					class="w-full rounded-lg border border-gray-200 shadow-sm" />
				<p class="text-center text-sm text-gray-500 mt-3">MobaXterm - ขั้นตอนที่ 2</p>
			</div>
		</div>
		...
		<div class="my-8">
			<img src="{imageBase}/image (14).png" alt="Jupyter Terminal"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-sm text-gray-500 mt-3">Jupyter Terminal</p>
		</div>
...
squeue -u Username`} />
		...
		<div class="my-10">
			<img src="{imageBase}/image (15).png" alt="SSH Job Submit"
				class="w-full rounded-lg border border-gray-200 shadow-sm" />
			<p class="text-center text-sm text-gray-500 mt-3">การส่งงานผ่าน SSH</p>
		</div>
	...
	<div class="max-w-4xl mx-auto px-6 py-10">
		...
		<div class="info-box">
			...
			<ul class="text-blue-700 text-sm list-none pl-0 mb-0 space-y-1">
				<li class="flex items-center gap-2"><span class="inline-block w-2.5 h-2.5 rounded-full bg-green-500"></span> <code>idle</code> = ว่าง</li>
				<li class="flex items-center gap-2"><span class="inline-block w-2.5 h-2.5 rounded-full bg-yellow-400"></span> <code>mix</code> = ใช้งานบางส่วน</li>
				<li class="flex items-center gap-2"><span class="inline-block w-2.5 h-2.5 rounded-full bg-red-500"></span> <code>alloc</code> = ใช้งานเต็ม</li>
				<li class="flex items-center gap-2"><span class="inline-block w-2.5 h-2.5 rounded-full bg-gray-500"></span> <code>down</code> = ไม่พร้อมใช้งาน</li>
			</ul>
		</div>
...
{:else if slug === 'scratch'}
	<div class="max-w-4xl mx-auto px-6 py-10">
		...
		<div class="warning-box">
			<p class="text-amber-800 mb-0"><strong>ข้อมูลใน /scratch จะถูกลบอัตโนมัติเมื่องานสิ้นสุด</strong></p>
		</div>
		...
		<div class="info-box mt-4">
			...
			<ul class="text-blue-700 text-sm list-none pl-0 mb-0 space-y-1">
				<li class="flex items-center gap-2">
					...
					<code>COMPLETED</code> = เสร็จสมบูรณ์
				</li>
				<li class="flex items-center gap-2">
					...
					<code>FAILED</code> = เกิดข้อผิดพลาด (ตรวจสอบไฟล์ .err)
				</li>
				<li class="flex items-center gap-2">
					<svg class="w-4 h-4 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
					<code>TIMEOUT</code> = ถึงเวลาสูงสุด (เพิ่ม --time)
				</li>
				<li class="flex items-center gap-2">
					<svg class="w-4 h-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" /></svg>
					<code>CANCELLED</code> = คุณหรือ Admin ยกเลิก
				</li>
				<li class="flex items-center gap-2">
					<svg class="w-4 h-4 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4" /></svg>
					<code>OUT_OF_ME+</code> = ใช้ RAM เกินที่ขอ (เพิ่ม --mem)
				</li>
			</ul>
		</div>
		...
		<div class="bg-green-50 border border-green-300 rounded-xl p-6 mb-8">
			...
			<ul class="text-green-700 space-y-2 list-none pl-0 mb-0">
				<li class="flex items-start gap-2">
					...
					ขอเฉพาะทรัพยากรที่ต้องการจริงๆ การขอเกินจะบล็อกผู้ใช้คนอื่น
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" /></svg>
					ใช้ <code>--partition=short</code> สำหรับการทดสอบ งานสั้นจะเริ่มได้เร็วกว่า
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
					ใช้ <code>/scratch</code> สำหรับข้อมูลชั่วคราวระหว่างการคำนวณ ไม่ใช่ <code>/home</code>
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" /></svg>
					บันทึก checkpoint สำหรับงานที่รันนาน กรณีที่ timeout
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
					ตรวจสอบไฟล์ผลลัพธ์ (.out/.err) เมื่องานล้มเหลว
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z" /></svg>
					ใช้ <code>sacct</code> เพื่อดูว่างานของคุณใช้ RAM จริงเท่าไร แล้วปรับ <code>--mem</code> ให้เหมาะสม
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
					ทำความสะอาดไฟล์ผลลัพธ์เก่าเพื่อประหยัดพื้นที่ดิสก์
				</li>
				<li class="flex items-start gap-2">
					<svg class="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 10h16M4 14h16M4 18h16" /></svg>
					ใช้ Array Job แทนการส่งงานแยกจำนวนมาก
				</li>
			</ul>
		</div>
